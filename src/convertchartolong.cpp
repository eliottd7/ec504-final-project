...
{ // code to convert the char string into a long array. Might be WIP since I havent tested in within a situation regarding the rest of the
  // project but it works outside of it.
